...
create index saved_words_user_id_idx on saved_words(user_id, created_at desc);
create index saved_words_user_next_practice_idx on saved_words(user_id, next_practice_at);
